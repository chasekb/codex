    ...
    "UserPromptSubmit": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "./skills/core/self-improvement/scripts/activator.sh"
          }
        ]
      }
    ],
    "PostToolUse": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "./skills/core/self-improvement/scripts/error-detector.sh"
          }
        ]
      }
    ]
    ...
    "UserPromptSubmit": [
      {
        ...
        "hooks": [
          {
            "type": "command",
            "command": "~/.claude/skills/core/self-improvement/scripts/activator.sh"
          }
        ]
      }
    ]
...
```bash
./skills/core/self-improvement/scripts/extract-skill.sh test-skill --dry-run
```
...
```bash
chmod +x ./skills/core/self-improvement/scripts/activator.sh
chmod +x ./skills/core/self-improvement/scripts/error-detector.sh
chmod +x ./skills/core/self-improvement/scripts/extract-skill.sh
```
...
```json
{
  "command": "/absolute/path/to/skills/core/self-improvement/scripts/activator.sh"
}
```
