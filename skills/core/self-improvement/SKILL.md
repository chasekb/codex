...
| `AGENTS.md` | Project facts, conventions, gotchas for Codex and agent workflows |
...
Create `.codex/settings.json` in your project for Codex CLI, or `.claude/settings.json` for Claude Code:
...
Use the same hook payload in `.claude/settings.json` if you are configuring Claude Code instead of Codex.
